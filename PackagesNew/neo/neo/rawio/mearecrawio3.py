...
class MEArecRawIO(BaseRawIO):
    ...
    def _parse_header(self, magnetic_dim = -1):
        print("MEArecrawio _parse_header function called")
        try:
            import MEArec as mr
            HAVE_MEAREC = True
        except ImportError:
        ...
        if magnetic_dim != -1:
            print("Magnetic Dim: ", magnetic_dim)
            print("Ziad Added in mearecrawio file: ", np.shape(self._recgen.mag_recordings))
