...
class Kilosort2Sorter(KilosortBase, BaseSorter):
    ...
    def _setup_recording(cls, recording, output_folder, params, verbose):
        print('Setup Recording - Kilosort2')
        p = params
        ...
        kilosort2_master_txt = kilosort2_master_txt.format(
            kilosort2_path=modify_path_locations(str(Path(Kilosort2Sorter.kilosort2_path).absolute())),
            output_folder=modify_path_locations(str(output_folder.absolute())),
            channel_path=modify_path_locations(str((output_folder / 'kilosort2_channelmap.m').absolute())),
            config_path=modify_path_locations(str((output_folder / 'kilosort2_config.m').absolute())),
        )
