...
class BaseRawIO:
    ...
    def parse_header(self, magnetic_dim = -1):
        """
        ...
        """
        #print("Parse Header self", self)
        #print("Parse Header Magnetic Dim: ", magnetic_dim)
        self._parse_header(magnetic_dim = magnetic_dim)
