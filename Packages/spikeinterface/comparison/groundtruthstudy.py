...
class GroundTruthStudy:
    ...
    @classmethod
    def create(cls, study_folder, gt_dict, magnetic_dim=-1, **job_kwargs):
        setup_comparison_study(study_folder, gt_dict, magnetic_dim=magnetic_dim, **job_kwargs)
        return cls(study_folder)

    def ziad_get_recordings(self):
    ...
    def get_recording(self, rec_name=None):
        print("GroundTruthStudy: GET_RECORDING CALLED")
        rec_name = self._check_rec_name(rec_name)
    ...
    def copy_sortings(self):
        ...
        for rec_name, sorter_name, output_folder in iter_output_folders(sorter_folders):
            print("Copy Sortings rec_name, sorter_name, output_folder: ", rec_name, sorter_name, output_folder)
            ...
            try:
                ...
                #print("sorting retrieved from folder: ", sorting)
                NpzSortingExtractor.write_sorting(sorting, npz_filename)
                #print("Sorting Extractor wrote npz file")
            except Exception as e:
                print("Copy_sortings exception: ", e)
                print("ERROR WRITING NPZ FILE - groundtruthstudy.py/copy_sortings")
