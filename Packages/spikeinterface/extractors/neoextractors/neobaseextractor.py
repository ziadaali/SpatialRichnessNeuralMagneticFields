...
class _NeoBaseExtractor:
    ...
    def __init__(self, magnetic_dim = -1, **neo_kwargs):
        neoIOclass = eval('neo.rawio.' + self.NeoRawIOClass)
        print("NeoIOClass: ", neoIOclass)
        print("Neo file: ", neo.__file__)
        self.neo_reader = neoIOclass(**neo_kwargs)
        self.neo_reader.parse_header(magnetic_dim = magnetic_dim)
...
class NeoBaseRecordingExtractor(_NeoBaseExtractor, BaseRecording):
    ...
    def __init__(self, stream_id=None, magnetic_dim = -1, **neo_kwargs):

        _NeoBaseExtractor.__init__(self, magnetic_dim = magnetic_dim, **neo_kwargs)
