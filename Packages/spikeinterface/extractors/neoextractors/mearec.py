...
class MEArecRecordingExtractor(NeoBaseRecordingExtractor):
    ...
    def __init__(self, file_path, locs_2d=True, magnetic_dim = -1):
        print("MEArecRecordingExtractor called")
        print("")
        neo_kwargs = {'filename': str(file_path)}
        NeoBaseRecordingExtractor.__init__(self, magnetic_dim = magnetic_dim, **neo_kwargs)
...
class MEArecSortingExtractor(NeoBaseSortingExtractor):
    ...
    def __init__(self, file_path, use_natural_unit_ids=True):
        print("MEArecSortingExtractor called")
        print("")
        neo_kwargs = {'filename': str(file_path)}
