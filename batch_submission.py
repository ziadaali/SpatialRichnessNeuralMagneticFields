...
#fields = [[0, 10]]
#fields = [-1, 0, 1, 2]
#fields = [[0, 100], [1, 100], [2, 100]]
#fields = [[0, 7], [1, 5], [2, 9]]
#fields = [[5, 6, 99], [7, 8, 9, 99], [-1, 0, 99], [5, 6, 101], [7, 8, 9, 101], [-1, 0, 101]]
#fields = [[5, 6, 100], [7, 8, 9, 100], [-1, 0, 100]]
#fields = [-1, 0, 1, 2, [5, 6], [7, 8, 9], [-1, 0]]
#fields = [2]
#fields = [[5, 6]]
#fields = [[7,8,9]]
fields = [-1, 0, 1, 2]
...
#fields = [-1, 0, [-1, 0]]
#fields = [4, [3, 4]]
#fields = [[-1, 0], [5, 6], [7, 8, 9]]
#fields = [[1, 2], [0, 1, 2]]
#fields = [[3, 4]]
#fields = [1, 2, [-1, 0], [5, 6], [7, 8, 9]]
#fields = [-1, 0, [-1, 0]]
#fields = [[-1, 0]]
...
def create_submit_script(cells, path, field):
    field_string = create_field_string([field])
...
for cells in numcells:
    for path in paths:
        for field in fields:
            create_submit_script(cells, path, field)
            submit_batch()
