import time
import numpy as np
from MEArecTemplate.tools import *
...
from MEArecTemplate.simulate_cells import compute_eap_for_cell_model, compute_eap_based_on_tempgen
...
class TemplateGenerator:
    ...
    def __init__(self, cell_models_folder=None, templates_folder=None, temp_dict=None, info=None, tempgen=None,
        ...
        if temp_dict is not None and info is not None:
            ...
            if 'mags' in temp_dict.keys():
                self.mags = temp_dict['mags']
            self.info = info
